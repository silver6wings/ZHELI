...
@implementation ActivityMineDataSource

+(ActivityMineDataSource*)pageDataSource
{
    ActivityMineDataSource* dataSource =  [[ActivityMineDataSource alloc] init];
	return dataSource;
}
...
- (id)init{
	self = [super init];
    if (self) {
        myModel = [[ListModel alloc] initWithParentDS:@"ActivityMine"];
    }
